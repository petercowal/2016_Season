...
public class ButtonControl {
	...
	public void update() {
		shooter.update(shooterSpeed, controller.getRawButton(5),
		...
		drivetrain.update(controller.getRawAxis(1), controller.getRawAxis(5),
				frontSolPressed, backSolPressed);
		intake.update(controller.getRawButton(1),controller.getRawButton(3));
		chainLift.update(controller.getRawButton(2), controller.getRawButton(4));
	}
}